...
profiles
	a python list of dicts specifying the supported transcoded 
        profiles. The dict should contain i) the id of the profile, 
        ii) the command to be executed with the first parameter to be 
        the input and the second the output file, and iii) the list 
        of supported mime types for this profile
